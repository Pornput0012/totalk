...
export default function HomeView() {
    ...
    useEffect(() => { if (userJoined) { navigate("/qaa") } }, [userJoined])
                ...
                <div className="space-y-4 mt-10">
                    ...
                    >
                        ...
                        >
                            ...
                            <p className="mt-4 text-sm text-gray-500">แชร์เลขห้องให้เพื่อน join เลย!</p>
                            <div className="modal-action mt-6">
                                <form method="dialog">
                                    <button onClick={deleteRoom} className="btn border-yellow-400 bg-yellow-500">ปิด</button>
                                </form>
                            </div>
                        </div>
                    </dialog>
                    ...
                    >
                        ...
                        >
                            ...
                            <button
                                onClick={joinRoom}
                                className="btn bg-yellow-500 border-yellow-400 mt-6 px-4 w-[50%]">เข้าร่วมห้อง</button>
                            <div className="modal-action mt-6">
                                <form method="dialog">
                                    <button onClick={deleteRoom} className="btn bg-gray-200">ปิด</button>
                                </form>
                            </div>
                        </div>
                    </dialog>
